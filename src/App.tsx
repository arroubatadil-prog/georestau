...
const App: React.FC = () => {
  ...
  if (loading) {
    return (
      <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-br from-orange-300 via-orange-400 to-orange-600">
  ...
  if (!selectedRole) {
    return (
      <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-br from-orange-300 via-orange-400 to-orange-600 p-4 sm:p-6 font-sans text-white overflow-y-auto">
        ...
        <div className="mb-4 sm:mb-6 animate-fadeIn relative group">
          ...
          <div className="absolute inset-0 bg-orange-300/30 rounded-full blur-3xl animate-pulse"></div>
          <div className="absolute inset-0 bg-white/15 rounded-full blur-2xl"></div>
          ...
          <div className="relative">
            <img
              src="/logo.png"
              alt="GeoResto Logo"
              className="w-24 h-24 sm:w-28 sm:h-28 md:w-32 md:h-32 object-contain shadow-[0_0_40px_rgba(255,255,255,0.8)] hover:shadow-[0_0_60px_rgba(255,255,255,1)] hover:scale-110 transition-all duration-500 drop-shadow-[0_0_20px_rgba(255,255,255,0.9)] brightness-110 contrast-110"
